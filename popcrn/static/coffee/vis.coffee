...
texts = [
  {key:"deadpool",file:"../../../static/data/deadpool.csv",name:"Deadpool"}
  {key:"apple",file:"../../../static/data/apple.csv",name:"Apple"}
  {key:"datascience",file:"../../../static/data/data_science.csv",name:"Data Science"}
]
